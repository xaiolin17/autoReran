...
def fetch_stock_data_task(self, stock_code: str, period: str = "1d", start_date: str = None, end_date: str = None):
...
def train_model_task(self, stock_code: str, model_name: str, model_type: str = "RandomForest",
                     feature_columns: list = None, target_column: str = "close_price",
...
@celery_app.task(bind=True)
def run_backtest_task(self, stock_code: str, strategy_name: str, start_date: str, end_date: str,
                      initial_capital: float = 100000.0, params: dict = None):
    task_id = self.request.id
    ...
    try:
        ...
        logger.error(error_msg)
        update_task_status(task_id, task_type, "failed", 0, None, error_msg)
        return {"status": "error", "stock_code": stock_code, "strategy_name": strategy_name, "message": str(e)}
